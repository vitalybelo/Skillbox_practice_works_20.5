 ...
 * Реализован класс ATM который инициализируется = количеством банкнот
 * Вначале, случайным подбором заполняются слоты с банкнотами от 5000 до 100
 * Далее реализуется выдача по запрашиваемой сумме: если в банкомате есть
